  ...
  transports: [
    {
      ...
      notes: 'Frecciarossa directo o con cambio en Roma. Reserva con antelación para mejores precios.',
    },
    {
      type: 'train',
      from: 'Florencia',
      ...
      price: '€50-80',
      link: 'https://www.trenitalia.com',
      notes: 'Vía Génova o Pisa. Tren panorámico por la Riviera Ligure.',
    },
  ],
  activities: [
    { date: '29 abr', description: 'Llegada desde Salerno, paseo centro histórico, Piazza della Signoria, Ponte Vecchio', isBase: true },
    { date: '30 abr', description: 'Uffizi (mañana), Duomo, Accademia (tarde), Piazzale Michelangelo (atardecer)' },
  ],
  tips: [
